...
void main()
{
    ...
    /* 
      Creates a down scaled brick, in order to repeat it multiple times
      brick_mortar_w width of bricks with mortar included
      brick_mortar_h height of bricks with mortar included 
    */
    ...
    // Adds a offset to every second brick line
    ...
    // Creates the repetition for width and height on the screen
    x -= floor(x);
    y -= y_index;
    ...
    /*
      This part chooses the right color for the segment. The smooth step function is used in order to get
      no hard edges and the bias for a darker inner mortal edge
      w calculates the points where the vertical mortal should be displayed
      h calculates the points where the horizontal mortal should be displayed
    */
    ...
    // colors the fragment with the calculated color
