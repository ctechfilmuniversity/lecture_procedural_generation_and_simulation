...
void main()
{
    ...
    //scale canvas size to brick size
    ...
    //add an offset of 0.5 to the right on the x-axis to every second row
    ...
    //repeating the single brick along both axis 
    x -= floor(x);
    y -= y_index;
    ...
    //color the bricks with a gradient outline
