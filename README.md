...
* In [`docs/01_sessions`](01_sessions) you find a [folder](01_sessions/01/) with an index for each week (session = week).
...
* In [`docs/02_scripts`](02_scripts) you find all scripts.
* In [`assignments`](03_assignments) you submit your work each week to the folder with your last name and a folder with the session index. You will submit all assignments to the same folder (the one with your last name).
